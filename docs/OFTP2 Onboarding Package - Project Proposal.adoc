...
* Note: The CMA API access is part of the CMA ENTERPRISE service but not necessarily used for OFTP2 onboardings, therefore not adressed here
...
* Development and deployment of the CMA API feature is excluded
